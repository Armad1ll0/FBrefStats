# -*- coding: utf-8 -*-
"""
Created on Mon Sep  6 16:49:28 2021
...
stats = ["player","nationality","position","squad","age",'birth_year', "minutes_90s","sca","sca_per90", "sca_passes_live", "sca_passes_dead", "sca_dribbles", "sca_shots", "sca_fouled", "sca_defense", "gca", "gca_per90", "gca_passes_live", "gca_passes_dead", "gca_dribbles", "gca_shots", "gca_fouled", "gca_defense"]
...
shot_creation_stats_eng_2020_2021 = frame_for_category('gca/2020-2021-',top,end,stats)

#web = 'https://fbref.com/en/comps/13/10732/shooting/2020-2021-Ligue-1-Stats'
top='https://fbref.com/en/comps/13/'
end='Ligue-1-Stats'
shot_creation_stats_fr_2020_2021 = frame_for_category('10732/gca/2020-2021-', top,end,stats)
...
shot_creation_stats_ger_2020_2021 = frame_for_category('10737/gca/2020-2021-', top,end,stats)

#web = 'https://fbref.com/en/comps/11/10730/shooting/2020-2021-Serie-A-Stats'
top='https://fbref.com/en/comps/11/'
end='Serie-A-Stats'
shot_creation_stats_ita_2020_2021 = frame_for_category('10730/gca/2020-2021-', top,end,stats)

#web = 'https://fbref.com/en/comps/12/10731/defense/2020-2021-La-Liga-Stats'
top='https://fbref.com/en/comps/12/'
end='La-Liga-Stats'
shot_creation_stats_spa_2020_2021 = frame_for_category('10731/gca/2020-2021-', top,end,stats)

#merging the top 5 leagues data 
shot_creation_stats_big5_2020_2021 = shot_creation_stats_eng_2020_2021.append([shot_creation_stats_fr_2020_2021, shot_creation_stats_ger_2020_2021, shot_creation_stats_ita_2020_2021, shot_creation_stats_spa_2020_2021])

#%%
shot_creation_stats_big5_2020_2021.to_csv('FB_ref_shot_creation_stats_2020_2021.csv', encoding = 'utf-8')
...
def player_shot_creation_radar(player_name, shot_creation_stats_big5_2020_2021):
    ...
    row = shot_creation_stats_big5_2020_2021.loc[shot_creation_stats_big5_2020_2021['player'] == player_name]
    #creating a new dataframe that we can create a radar graph from 
    columns = ['Shot/Goal Creation Stats', 'Numbers', 'Percentile']
    df = pd.DataFrame(columns=columns)
    #slicing the dataframe as we canny compare names really 
    comparison_vals = shot_creation_stats_big5_2020_2021.loc[:, 'minutes_90s':'gca_defense']
    for column in comparison_vals:
        ...
        new_row = {'Shot/Goal Creation Stats':column, 'Percentile': percentile, 'Numbers': row[column].iloc[0]}
    ...
    plt.xticks(theta[:-1], df['Shot/Goal Creation Stats'], color='grey', size=12)
    ax.tick_params(pad=10) # to increase the distance of the labels to the plot
    # fill the area of the polygon with green and some transparency
    ax.fill(theta, values, 'green', alpha=0.1)
    
    # plt.legend() # shows the legend, using the label of the line plot (useful when there is more than 1 polygon)
    plt.title("Shot/Goal Creation Stats of " + str(player_name) +'\n' + 'Given in Percentiles.')
    print(df)
    return plt.show(), df

#stats for some players may be expontential as this includes players who have only played a few minutes as well. 
player_shot_creation_radar('Saïd Benrahma', shot_creation_stats_big5_2020_2021)